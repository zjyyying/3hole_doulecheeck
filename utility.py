...
def get_double_append(i,n,s1,o1,x1,y1,z1,s2,o2,x2,y2,z2,s3,o3,x3,y3,z3,\
                      d_list,p_list,idx,hole3_part, double_part): 
    if o1 in pam.Ni_Cu_orbs and o2 in pam.Ni_Cu_orbs: #and not (o3 in pam.Ni_Cu_orbs and o4 in pam.Ni_Cu_orbs):
        d_list.append(i)
        idx.append(n); hole3_part.append([s3, o3, x3, y3, z3])
